...
This code will run on all three platforms with one code base! It shares assets and Game Scenes under the "Universal Game" folder. This is meant to be a starter template. The example game play can easily be replaced. The controls (touches & mouse clicks) are abstracted out in the "Universal Game" section. This allows everything to be run from a shared code base. Write once, run on three platforms!
